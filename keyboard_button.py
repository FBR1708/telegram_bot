...
rp_button = [
    ...
    # KeyboardButton(text='Reklamani guruhlarga tarqatish')],
]
...
countries_button = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text='Telegram', url='https://t.me/Ustalar_24_7'),
     InlineKeyboardButton(text='Facebook',
                          url='https://www.facebook.com/profile.php?id=100091343606042&mibextid=V3Yony')],
    [InlineKeyboardButton(text='Instagram',
                          url='https://instagram.com/httpst.mespes_texnika_24_7?igshid=MzRlODBiNWFlZA=='),
